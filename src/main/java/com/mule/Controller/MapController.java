...
import main.java.com.mule.Model.Map;
import main.java.com.mule.Model.Mule;
...
/**
 * Map main.java.com.mule.Controller Class.
 */
        ...
        for (Player play : Main.myGame.getPlayers()) {
          if (play.getTileOwned(i, j)) {
            ...
            if (mule != null) {
              ImageView muleImg;
              if (mule == Mule.FOOD) {
                muleImg = new ImageView("/main/resources/View/Resources/tinyFoodMule.png");
              } else if (mule == Mule.ENERGY) {
                muleImg = new ImageView("/main/resources/View/Resources/tinyEnergyMule.png");
              } else {
                muleImg = new ImageView(
                        "/main/resources/View/Resources/tinySmithoreMule.png");
              }
      ...
      switch (gameset.getPhase()) {
        ...
        case "Emplacing Mule":
          ...
          if (gameset.getMuleType() == Mule.FOOD) {
            mule = new ImageView("/main/resources/View/Resources/tinyFoodMule.png");
          } else if (gameset.getMuleType() == Mule.ENERGY) {
            mule = new ImageView("/main/resources/View/Resources/tinyEnergyMule.png");
          } else {
            mule = new ImageView("/main/resources/View/Resources/tinySmithoreMule.png");
          }
