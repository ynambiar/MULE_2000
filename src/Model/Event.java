...
public enum Event implements Serializable {
    ...
    public int[] getEffects() {
        ...
        switch (this) {
            ...
            case SIX:
                return new int[] { 0,
                        (int) (Main.myGame.getCurrentPlayer().getFood() * -.5), 0,
                        0 };
            case SEVEN:
    ...
    public String toString() {
        ...
        switch (this) {
            ...
            case SEVEN:
                return "Your space gypsy in-laws made a mess of the town. It cost you $"
                        + m * 6 + " to clean it up!";
            case EIGHT:
                return "A clumsy mule dropped a pile of " + (m / 10)
                        + " ore. Finders keepers, losers weepers!";
            case NINE:
                return "It started to rain and you lost 2 energy units wandering through the mountains.";
            case TEN:
                return "You happened upon a field of daisies and took a nap. You gained "
                        + (m / 10) + " units of energy.";
            case ELEVEN:
                return "Production went up and the market's doing well! Everyone gains $"
                        + (m * 4) + ".";
            case TWELVE:
